...
<body>
    ...
    <!-- NIFT Study Material - Study Material Kit  -->
    <section class="nid-study-kit-section">
    <div class="nid-study-kit">
        <div class="nid-kit-header">
            <h1 class="nid-kit-title">NIFT Study Material</h1>
            <p class="nid-kit-subtitle">Study Material Kit</p>
        </div>

        <div class="nid-selections-grid">
            <div class="nid-achievement-card">
                <div class="nid-selection-count">12,346</div>
                <div class="nid-achievement-label">NIFT Selections since 2005</div>
            </div>

            <div class="nid-achievement-card">
                <div class="nid-selection-count">2207</div>
                <div class="nid-achievement-label">Selections in NIFT 2024</div>
            </div>

            <div class="nid-achievement-card">
                <div class="nid-selection-count">1-10</div>
                <div class="nid-achievement-label">All India rank 1 to 10<br>in NIFT 2024 from BRDS</div>
            </div>

            <div class="nid-achievement-card">
                <div class="nid-selection-count">92</div>
        ...
        <div class="nid-expert-section">
            <p class="nid-expert-message">
                Get comprehensive study materials designed by experts who have consistently produced top rankers in NIFT entrance examinations.
            </p>
            <a href="#form">
    ...
    <!-- End NIFT Study Material - Study Material Kit  -->
    ...
    <section class="body_exam">
        <div class="container_exam">
          ...
          <div class="section-header_exam fade-in_exam">
            <h2 class="section-title_exam course_exam">Reasons to Choose BRDS NIFT Study Material</h2>
          </div>
          ...
          <div class="swiper courses-slider_exam">
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide">
                <div class="course-card_exam fade-in-up_exam">
                  <div class="course-header_exam shimmer_exam">
                    <h3 class="course-title_exam">12 books for DAT & GAT preparation</h3>
                  </div>
                  <div class="course-content_exam">
                    <img src="https://images.unsplash.com/photo-1481627834876-b7833e8f5570?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80" alt="Study Books" style="width: 400px; height: 200px; object-fit: cover; border-radius: 0 0 12px 12px;" />
                  </div>
                </div>
              </div>
              ...
              <!-- Card 5: NIFT Situation Test Coaching Kit -->
              <div class="swiper-slide">
                <div class="course-card_exam fade-in-up_exam">
                  <div class="course-header_exam shimmer_exam">
  ...
  <section class="nid_books_section">
    <div class="nid_books_container">
        ...
        <div class="nid_books_header">
            <h2 class="nid_books_title">Details of Books for Comprehensive Preparation of NIFT DAT Mains</h2>
        </div>
        ...
        <div class="nid_books_grid">
            <div class="nid_book_item">
                ...
                <h3 class="nid_book_title">NIFT 15 years Original papers</h3>
            </div>
            ...
            <div class="nid_book_item">
                ...
                <h3 class="nid_book_title">NIFT fully solved papers</h3>
            </div>
